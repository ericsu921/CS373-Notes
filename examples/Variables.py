...
b = b + [5]                 # here, we are changing b itself (the reference). b += [5] is not the same as b = b + 5 for lists
assert a == [2, 3, 4]
assert b == [2, 3, 4, 5]    # it looks like python built a brand new list and assigned it to b
...
b = a
assert a is b
b = b + (5,)                # also changing b itself, for immutables, it always changes the reference by building a brand new object and changing the reference to point at it
assert a == (2, 3, 4)
assert b == (2, 3, 4, 5)
